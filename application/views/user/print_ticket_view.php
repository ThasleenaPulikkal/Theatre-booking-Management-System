                        ...
                        <table class="venue">
                            <tr>
                                ...
                                <th>
                                    ...
                                    <p class="screenname" style="font_size:18px;font_weight:400px;" >Seat Name </p><br>
                      ...
                      <?php if($key==0){?>
                        ...
                        <table class="venue" style="border:none; margin-bottom: 0;">
                            ...
                            <tr style="    font-size: 18px;">
                                ...
                                <td style="padding: 0;font-size: 18px;font-weight: 600;" class="showtime"><?php echo $row->Reservation_Time;?></td>
