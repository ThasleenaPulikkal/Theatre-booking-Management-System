          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="title_right">
                ...
                <div class="col-md-1 col-sm-2 col-xs-4 pull-right form-group "> <a href="" type="button" class="dropdown-toggle info-number"  title="Add New Service" data-toggle="modal" data-target="#add-more"> <span class="addmdlbtn"> + </span> </a>
                          ...
                          <div class="">
                            <form class="form-horizontal form-label-left" novalidate>
                              <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-4 col-xs-12" for="name">Title <span class="required">*</span> </label>
                              ...
                              <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-4 col-xs-12" for="textarea">Image <span class="required">*</span> </label>
                                <div class="col-md-10 col-sm-8 col-xs-12">
                                  <div class="box">
                                    ...
                                    <label for="file-7"><span></span> <strong><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17">
                                      ...
                                      </svg> Choose a image</strong></label>
                                  </div>
                                </div>
                              </div>
                    ...
                    <div class="">
                      <div class="tabmargntp30">
                        <div class="row">
                          ...
                          <div class="col-md-55">
                            <div class="thumbnail">
                              <div class="image view view-first"> <img style="width: 100%; display: block;" src="../images/media.jpg" alt="image" />
                                <div class="mask"> 
                                  <!--<p>Your Text</p>-->
                                  <div class="tools tools-bottom"> 
                                    <!-- edit popup button--> 
                                    <a type="button" class="" href="" data-toggle="modal" data-target="#gallery1"><i class="fa fa-pencil"></i></a> 
                                    <!-- edit popup button end here--> 
                            ...
                            <!--============================popup gallery1 =================================-->
                            <div id="gallery1" class="modal fade" role="dialog">
                              <div class="modal-dialog"> 
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form class="form-horizontal form-label-left" novalidate>
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-6 col-md-offset-2">
                                          <button id="send" type="submit" class="btn btn-primary"><i class="fa fa-check-square-o" aria-hidden="true"></i> Update</button>
                                        </div>
                                      </div>
                                    </form>
                                  </div>
                     ...
                     <!--##################### col-md-55 end here ############################-->  
                      ...
                      <div class="col-md-55">
                            <div class="thumbnail">
                              <div class="image view view-first"> <img style="width: 100%; display: block;" src="../images/media.jpg" alt="image" />
                                <div class="mask"> 
                                  ...
                                  <div class="tools tools-bottom"> 
                                    <!-- edit popup button--> 
                                    <a type="button" class="" href="" data-toggle="modal" data-target="#gallery2"><i class="fa fa-pencil"></i></a> 
                                    <!-- edit popup button end here--> 
                                    <a href="#"><i class="fa fa-times"></i></a> </div>
                                </div>
                              </div>
                            ...
                            <!--============================popup gallery1 =================================-->
                            <div id="gallery2" class="modal fade" role="dialog">
                              <div class="modal-dialog"> 
                     ...
                     <!--##################### col-md-55 end here ############################-->  
                      ...
                      <div class="col-md-55">
                            <div class="thumbnail">
                              <div class="image view view-first"> <img style="width: 100%; display: block;" src="../images/media.jpg" alt="image" />
                                <div class="mask"> 
                                  ...
                                  <div class="tools tools-bottom"> 
                                    <!-- edit popup button--> 
                                    <a type="button" class="" href="" data-toggle="modal" data-target="#gallery3"><i class="fa fa-pencil"></i></a> 
                                    <!-- edit popup button end here--> 
                                    <a href="#"><i class="fa fa-times"></i></a> </div>
                                </div>
                              </div>
                            ...
                            <!--============================popup gallery1 =================================-->
                            <div id="gallery3" class="modal fade" role="dialog">
                              <div class="modal-dialog"> 
