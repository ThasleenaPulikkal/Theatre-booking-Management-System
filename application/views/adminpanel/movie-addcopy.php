                ...
                <div class="">
                 ...
                 <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                      <label>Movie *</label>
                        <input type="text" placeholder="Movie name" class="form-control" name="moviename" >
                      </div>
                       <div class="col-md-4 col-sm-6 col-xs-12 form-group ">
                       ...
                       <?php foreach($records as $lang){ ?>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                        <label>Date</label>
                        <input type="text" placeholder="date of show" name="sdate" id="sdate"  class="form-control validate[required]" readonly>
                      
                      </div>
                      <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                      <label>Starting Time *</label>
                        <input type="text" placeholder="stime" class="form-control" name="stime" >
                      </div>
                      <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                      <label>Ending Time *</label>
                        <input type="text" placeholder="stime" class="form-control" name="etime" >
                      </div>
                       <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                        <label>Status*</label>
