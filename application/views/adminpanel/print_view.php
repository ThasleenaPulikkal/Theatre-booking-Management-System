...
<style>
    ...
    .disabletime {
        background-color: rgba(154, 154, 154, 0.53) !important;
        color: #fff;;
    }
...
<br>
 ...
 <button  type="button" style="margin left:400px" class="bdetails" data-toggle="modal" data-target="#mymodals" id="tkt_submit"  name="submit">
                             click here for print ticket</button>
